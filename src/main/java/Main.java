...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hubConnection.on("Registered", (id) -> {
            ...
            GameObject bot = new GameObject(id, 10, 20, 0, position, ObjectTypes.PLAYER, EnumSet.noneOf(Effects.class), 0, 0, 0, 0);
        ...
        hubConnection.send("Register", token, "TheLegend27");
